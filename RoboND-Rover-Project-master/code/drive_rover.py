...
class RoverState():
    def __init__(self):
        ...
        # Track number of obstacle pixels and navigable pixels
        self.worldmapcnt = np.zeros((200, 200, 3), dtype=np.float) 
        ...
        self.count = 0 # For tracking if we're stuck
        self.yaw_average = np.ones(5) 
        self.yaw_var = 0 # variance of yaw average
